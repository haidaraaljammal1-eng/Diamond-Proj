...
import styles from "./renewal-link-error.module.css";

interface RenewalLinkErrorProps {
  reason: string | null;
}

export function RenewalLinkError({ reason }: RenewalLinkErrorProps) {
  ...
  return (
    <div className={styles.page} data-testid="renewal-link-error">
