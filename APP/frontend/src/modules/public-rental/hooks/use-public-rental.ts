...
export function usePublicRental(token: string) {
  ...
  return {
    ...
    simulationPending: store.simulationPending,
    ...
    tarsOtpRequestPending: store.tarsOtpRequestPending,
    tarsOtpVerifyPending: store.tarsOtpVerifyPending,
    tarsOtpError: store.tarsOtpError,
    requestTarsOtp: store.requestTarsOtp,
    verifyTarsOtp: store.verifyTarsOtp,
  };
}
