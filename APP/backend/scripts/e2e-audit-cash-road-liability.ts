/**
 * Audits CASH road liability collection after Playwright E2E.
 * Usage: npx tsx scripts/e2e-audit-cash-road-liability.ts --liability=<id>
 */
...
async function main() {
  ...
  console.log(`E2E_CASH_RL_AUDIT_JSON=${JSON.stringify(payload)}`);
  await app.close();
}
